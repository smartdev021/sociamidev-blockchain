...
import NewLandingPageContent from "~/src/theme/new_ui/NewLandingPageContent";
...
class LandingPage extends React.Component {
  ...
  renderRoutes() {
    return (
      <Switch>
        <Route exact path="/" render={routeProps => <NewLandingPageContent {...routeProps} {...this.props} />} />
        ...
        <Route path="*" render={routeProps => <NewLandingPageContent {...routeProps} {...this.props} />} />
      </Switch>
    );
  }
