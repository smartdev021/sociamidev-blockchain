          ...
          <span>
            <input type="text" id="project_nature" name="city" list="roadmaps" 
              className="text-field form-control validate-field required" 
                onChange={(e)=>props.handleChangeProject(e)} value={props.project.nature} />
          ...
          <span>
                  ...
                  <div className="form-group">
                    <input type="text" className="text-field form-control validate-field required" data-validation-type="string" 
                      id="project_name" name="project_name" autoComplete="off" placeholder="Name of Project" autoFocus
                        onChange={(e)=>props.handleChangeProject(e)} value={props.project.name}/>
                  </div>
                </div>
              </div>
              <div className="row">
                <div className="col-lg-12">
                  <div className="form-group">
                    <textarea id="project_desc" placeholder="Please Describe Your Project" className="form-control validate-field required" 
                      name="project_desc" onChange={(e)=>props.handleChangeProject(e)} value={props.project.description} />
                  </div>
                </div>
              </div>
              <div className="row">
                  ...
                  <div className="form-group input-group">
                    <input type="text" className="text-field form-control validate-field required" data-validation-type="string" 
                      id="milestone_name" name="milestone_name" autoComplete="off" 
                        placeholder="Milestone name" onChange={(e)=>props.handleChangeMilestone(e)}
                ...
                <div className="col-lg-6">
                  <div className="form-group">
                        <textarea id="milestone_desc" placeholder="Please describe the Milestone" className="form-control validate-field required" 
                          name="milestone_desc" onChange={(e)=>props.handleChangeMilestone(e)}
                          value={props.milestoneTemp.description}/>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="milestone-add-button">
                  <ActionLink href="#" className="popup-new-project-link-default" onClick={(e)=> props.handleMilestoneAdd(e)} style={{color:"black"}}>
              ...
              <div className="row">
                <div className="col-lg-4">
                  <div className="form-group">
                    <input type="number" className="text-field form-control validate-field required" data-validation-type="number" 
                      id="milestone_price" name="milestone_price" autoComplete="off" placeholder="Min Token" 
                        onChange={(e)=>props.handleChangeMilestone(e)}
                        value={props.milestoneTemp.price} min="1"/>
                  </div>
                </div>
                  ...
                  <div className="form-group">
                    <input type="date" className="text-field form-control validate-field required" data-validation-type="string" 
                      id="milestone_date" name="milestone_date" autoComplete="off" placeholder="Date" 
                        onChange={(e)=>props.handleChangeMilestone(e)} defaultValue={formatDate(props.milestoneTemp.date, '-')}/>
                  </div>
                </div>
                <div className="col-lg-12">
                  <div>
      ...
      return (
        <span>
          <div className="col-lg-6">
            ...
            <div className="col-lg-6">
              <div className="create-project-desc-column">
                 <ActionLink href="#" id={i} className="popup-new-project-link-default" onClick={(e)=> props.handleMilestoneDelete(e)}>
           ...
           <div className="col-lg-12">
             <div className="close-button-container">
               <button type="button" className="btn btn-lg btn-outline button-close" 
                 onClick={() => props.handleCloseAndSave()}>Close</button>
            </div>
          </div>
       </div>
     </span>
