...
import LandingComponentContent from "~/src/theme/components/landingPage/LandingComponentContent";
...
import '~/src/theme/css/landingContent.css';
  ...
  renderRoutes() {
    return (
      <Switch>
        ...
        <Route exact path='/landing' render={routeProps => <LandingComponentContent {...routeProps}{...this.props}/>}/>
