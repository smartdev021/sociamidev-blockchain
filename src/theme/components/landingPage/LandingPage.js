...
const AboutComponent = () => {
  return (
    <div className="about-wrapper">
      ...
      <h3>
        Join quests across different roles for the #futureofwork and team up with others to accomplish common
        goals! We call this -{' '}
        <span>
          The Game For Life.<br />
        </span>{' '}
        Isn’t this amazing?
      </h3>
    ...
    <div className="banner-wrapper">
      ...
      <div>
        <section>
          ...
          <p>
            Plug in for the Future. Explore a world of quests with <br /> friends and play them together to
            gain glory and rewards.
          </p>
        </section>
        <button type="button" className="explore-button">
          <p>Explore Soqqle</p>
        </button>
        <button type="button" className="sign-in-button" onClick={() => openSignUpForm()}>
          <p>Sign in</p>
        </button>
      </div>
    </div>
...
const Footer = () => {
  return (
    <footer className="footer">
      ...
      <div>
        <input type="email" className="mail" value="Mail" />
      </div>
      ...
      <h4>
        &#169;2018 SOQQLE, INC. ALL RIGHTS RESERVED.<br />
    ...
    <div className="our-blog">
      ...
      <section>
        <div className="one-news">
          <img src="https://s3.us-east-2.amazonaws.com/sociamibucket/assets/images/landingPage/blog-1.png" />
          <article>
            <p className="date">15.05.18</p>
            <h3>
              Can Blockchain be Trusted with <br /> all these Wallet Vulnerabilities?
            </h3>
            <p>
        ...
        <div className="two-news">
          <div className="top-news">
            <img src="https://s3.us-east-2.amazonaws.com/sociamibucket/assets/images/landingPage/blog-2.png" />
            <article>
              <p className="date">15.05.18</p>
              <h3>
                We closed our Soqqle Alpha last <br /> week — you won’t believe what we got.
              </h3>
              <p>
                Our Marvelous platform caught the eyes of <br /> everyone we demoed to.
              </p>
            </article>
          </div>
          <div className="bottom-news">
            <img src="https://s3.us-east-2.amazonaws.com/sociamibucket/assets/images/landingPage/blog-3.png" />
            <article>
              <p className="date">15.05.18</p>
              <h3>Singapore for a Blockchain Hub?</h3>
              <p>
                spent 4 years in Hong Kong before moving <br /> back to Singapore. The difference and why?{' '}
                <br /> It isn’t ALL about Blockchain.
              </p>
            </article>
          </div>
        </div>
      </section>
      <button type="button" className="all-news-button">
        <p>See all news</p>
      </button>
    </div>
  );
    ...
    <div className="talk-about-us">
      ...
      <section className="background-section-1">
        ...
        <article>
          <h3>Pek Yun Ning</h3>
          <p>
            I think the concept of a Game-Based experienceto explore a world of opportunities is superb. I
            can’t wait to hear more about and take part in the BETA!
          </p>
        </article>
        <img
      ...
      <section className="main-section">
        ...
        <article>
          <h3>Pek Yun Ning</h3>
          <p>
            I think the concept of a Game-Based experience <br />to explore a world of opportunities is
            superb. <br /> I can’t wait to hear more about and take part <br />in the BETA!
          </p>
        </article>
        <img
          className="twitter-mobile"
      ...
      <section className="background-section-2">
        ...
        <article>
          <h3>David Avetyan</h3>
          <p>
            Thank you for a great website.I like it very very <br /> much. It helped me a lot. Thanks a
            lot..Thank <br /> you for a great website.I like it very very much. <br /> It helped me a lot.
            Thanks a lot..Thank you for a great <br /> website. I like it very very much. It helped me a lot.{' '}
            <br /> Thanks a lot..
          </p>
        </article>
        <img
...
const VideoComponent = () => {
  return (
    <div className="video">
      ...
      <button type="button" className="all-videos-button">
        <p>See all videos</p>
      </button>
    </div>
  );
    ...
    <div className="work-explanation">
      ...
      <section className="select-house clearfix">
        ...
        <div className="description">
          ...
          <p>
            Join an environment where people similar to you gather and complete similar tasks. Develop
      ...
      <section className="select-hero clearfix">
        ...
        <div className="description">
          ...
          <p>
            Select a hero and develop it through tasks, answering questions, solving challenges individually
      ...
      <section className="get-reward clearfix">
        ...
        <div className="description">
          ...
          <p>
            Cumulate SOQQ Sparks, Achievements and Bonuses upon the completion of tasks. Get more for doing
            Group Tasks.
          </p>
      ...
      <section className="use-rewards clearfix">
        ...
        <div className="description">
          ...
          <p>
            SOQQ Sparks are powered by Blockchain Force. Use them to boost experience gain, or obtain
            character upgrades.{' '}
          </p>
