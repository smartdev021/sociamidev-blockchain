            ...
            return(
                <div className="team-email-item-editing" key={index}>
                    <div className="team-email-edit-box">
                        <input className="team-email-edit-input" value={this.state.email.email} onChange={(e)=>this.setEmailAddress(e)}/>
                        <div className="team-email-edit-options">
                            <a className="pull-left team-email-edit-button team-email-cancel-btn" onClick={()=>this.onCancel()}>Cancel</a>
                            <a className="pull-right team-email-edit-button  team-email-save-btn" onClick={()=>this.saveEmailAddress()}>Save</a>
                        </div>
                    </div>
            ...
            if(email.accepted){
                ...
                return(
                    <div className="team-email-item" key={index}>
                        ...
                        <a className="fa fa-pencil edit-team-email-checkbox" onClick={()=>this.editEmailAddress()}></a>
                    </div>
                )
            }
        }
