...
function About(props) {
  return (<div className="container-fluid">
    ...
    <div className="row">
    <div className="col-lg-12">
  <p>Social networks have not changed in the last 10 years, 
    with big-data overloading masses with content without showing where to get more depth. 
    The solution consists of 3 modules - data-driven personalized roadmaps, meaningful social network and tokenized learning.</p>
    </div>
    </div>
    <div className="row">
    <div className="col-lg-12">
  <p className>As the world moves into the upcoming 4th industrial revolution, 
    with people expected to not just be unemployed but unemployable, 
    Soqqle sets out with the vision to produce a network of motivated and connected 
