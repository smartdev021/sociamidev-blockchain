...
class CharacterCreationFlow extends React.Component {
  ...
  renderCharacterCreationForm() {
    ...
    const progressValue = ((this.state.characterCreationFlowStepIndex + 1) / CharacterCreationFlowData.length) * 100;
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(withCookies(CharacterCreationFlow));